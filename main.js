...
function krsApplication(name, programId, gpa) {
  ...
  if (gpa >= 2.99) {
    ...
    sks = 21;
    message = `Hallo ${name}, berdasarkan IP semester lalu sebesar ${gpa}, kamu diwajibkan melakukan bimbingan dosen pembimbing pada prodi ${programName} dan hanya dapat mengambil SKS sebanyak ${sks} SKS untuk semester depan`;
